...
install: ## Install all resources (CR/CRD's, RBAC and Operator)
	...
	kubectl apply -f deploy/crds/bans.io_bansslice_crd.yaml -n ${NAMESPACE}
...
uninstall: ## Uninstall all that all performed in the $ make install
	...
	-kubectl delete -f deploy/crds/bans.io_bansslice_crd.yaml -n ${NAMESPACE}
...
build: ## Build Operator
	...
	operator-sdk build steven30801/bans5gc-operator:cluster-only
	$(call echo_green," ...... Pushing image ......")
	docker push steven30801/bans5gc-operator:cluster-only
